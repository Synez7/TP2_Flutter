...
class QuestionProvider extends ChangeNotifier {
  ...
  int _numberQuestions = 10; // nombre de questions du quizz
  ...
  int get _countClick => countClick;
  ...
  set totalRightAnswers(int number){
    _totalRightAnswers = number;
    notifyListeners();
  }
